...
country = {
	...
	COLONIZATION_PROTECTORATE_PROVINCE_MAINTAINANCE = 2,
	COLONIZATION_COLONY_PROVINCE_MAINTAINANCE = 3,
	...
	COLONIZATION_RELEASE_DOMINION_COST = 100,
